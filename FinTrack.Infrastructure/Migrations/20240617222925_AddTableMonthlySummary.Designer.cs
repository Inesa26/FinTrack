...
namespace FinTrack.Infrastructure.Migrations
{
    ...
    [Migration("20240617222925_AddTableMonthlySummary")]
    partial class AddTableMonthlySummary
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinTrack.Domain.Model.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FinTrack.Domain.Model.MonthlySummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinTrack.Domain.Model.Account", b =>
                {
                    b.HasOne("FinTrack.Domain.Model.ApplicationUser", "User")
                        .WithOne("Account")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinTrack.Domain.Model.ApplicationUser", null)
                        .WithMany()
